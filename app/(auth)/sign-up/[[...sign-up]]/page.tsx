...
export default function Page() {
  ...
  return (
    <div className={` bg-gray-100 text-black transition-colors duration-500 h-screen`}>
      ...
      <div className="bg-gray-100 flex items-center flex-col lg:flex-row justify-center min-h-[calc(100vh-62px)] gap-5 lg:gap-0">
   
        <div className="flex flex-col items-start justify-center py-5 lg:py-0 pl-0 lg:pl-8 xl:pl-40 animate-fadeIn">
        ...
        <div className="flex items-center justify-center w-1/2 animate-slideIn">
          <div className=" transition-transform duration-300 hover:scale-105 py-5 ">
            <SignUp />
          </div>
        </div>
      </div>
